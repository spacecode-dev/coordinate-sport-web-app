					...
					foreach ($notifications->result() as $row) {
						...
						<tr>
							...
							<td class="name">
								...
								echo anchor('customers/notifications/view/' . $row->notificationID, $row->subject);
								?>
							</td>
							<td>
							...
							<td>
								<div class='text-right'>
									<a class='btn btn-success btn-sm' href='<?php echo site_url('customers/notifications/view/' . $row->notificationID); ?>' title="View">
