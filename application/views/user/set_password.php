<?php echo form_open($submit_to, ['class' => 'form', 'id' => 'kt_login_signin_form']); ?>
	<div class="text-left">
	...
	<button id="kt_login_signin_submit" class="btn btn-primary font-weight-bold px-9 py-4 my-3 mx-4">Set New Password</button>
	<?php
echo form_close();
