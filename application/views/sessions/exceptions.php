...
if ($staff->num_rows() == 0) {
	...
	<div class="alert alert-info">
		No exceptions found. Do you want to <?php echo anchor('sessions/exceptions/'.$lessonID.'/new/', 'create one'); ?>?
	</div>
	<?php
} else {
	?>
							...
							<tr>
								...
								<td>
									<div class='text-right'>
										...
										<a class='btn btn-danger btn-sm confirm-delete exception' href='<?php echo site_url('sessions/exceptions/remove/' . $row->exceptionID); ?>' title="Remove">
